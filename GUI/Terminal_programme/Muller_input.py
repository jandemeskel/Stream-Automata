       ...
       ################################################################ State inputs Control ################################################################
        ...
        def all_states():
                ...
                if  any((not i.isalpha()) for i in states_temp):
                    ...
                    print (' Please label states using Alphabetic character(s) only,')
                    print('for instance " A B C"  or "One Two Three" corresponds to the first, second & third states ')
                    states_temp = all_states()
                    
                elif (len(states_temp) != len(set(states_temp))):
                    print("\n Entered input:", states_temp, " is invalid")
                    print (' Please ensure states do not have duplicate labels and  have a space between them, or instance " A B C" ')
                    print(' or "One Two Three" corresponds to the first, second & third states ')
                    states_temp = all_states()
